...
echo -e "\033[36;40;1m"
echo "=========================================="
echo "          NOMAN TOOLS ACCESS"
echo "=========================================="
echo -e "\033[0m"
echo -e "\033[33;1mAdmin Key Required To Use This Tool\033[0m"
echo -e "\033[37mContact Admin for Key:\033[0m"
echo -e "\033[36mWhatsApp: https://whatsapp.com/channel/0029VbAkW0SATRSeAAYjNv1Z\033[0m"
echo -e "\033[36mFacebook: https://www.facebook.com/md.norman.988\033[0m"
echo -e "\033[36mTelegram: https://t.me/NOMAN_HACKER_BD_Bot\033[0m"
echo ""

read -p "Enter Admin Key: " user_key

if [[ "$user_key" != "$admin_key" ]]; then
    echo -e "\033[31;1m✗ Invalid Admin Key! Tool Locked.✗\033[0m"
    echo -e "\033[33;1mPlease contact admin to get valid key\033[0m"
    exit 1
fi

echo -e "\033[32;1m✓ Access Granted! Starting NOMAN Tools...✓\033[0m"
sleep 2
...
|_| \_|\___/|_|  |_/_/   \_\_| \_|
  Ethical Hacker
\033[33;4mVersion:\033[0m 4            \033[33;4mCTRL+C:\033[0m exit          \033[33;4mAuthor:\033[0m Noman
\033[36;1mAdmin Contact:\033[0m
\033[35mWhatsApp: https://whatsapp.com/channel/0029VbAkW0SATRSeAAYjNv1Z\033[0m
\033[35mFacebook: https://www.facebook.com/md.norman.988\033[0m
\033[35mTelegram: https://t.me/NOMAN_HACKER_BD_Bot\033[0m
